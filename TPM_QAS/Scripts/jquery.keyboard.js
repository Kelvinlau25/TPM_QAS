...
$.keyboard = function(el, options){
	...
	$.keyboard.layouts = {
		...
		'dvorak' : {
			'default': [
				'` 1 2 3 4 5 6 7 8 9 0 [ ] {bksp}',
				'{tab} \' , . p y f g c r l / = \\',
				'{lock} a o e u i d h t n s - {accept}',
			...
			'shift' : [
				'~ ! @ # $ % ^ & * ( ) { } {bksp}',
				'{tab} " < > P Y F G C R L ? + |', 
				'{lock} A O E U I D H T N S _ {accept}',
				'{shift} : Q J K X B M W V Z {shift}',
				'{space} {cancel}'
			]
		},
	...
	$.keyboard.defaultOptions = {
		...
		display : {
            ...
            'enter'  : 'Enter:Accept (Shift-Enter)',
			'lock'   : 'Caps:\u21ea Caps Lock', // caps lock
			'next'   : 'Next \u21e8',
			'prev'   : '\u21e6 Prev',
